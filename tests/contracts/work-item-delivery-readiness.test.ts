...
const action = {
  ...
  enabled: true,
  kind: 'navigate',
  target: { kind: 'object', object_type: 'execution_package', object_id: 'pkg-1', href: '/executions/exec-1' },
} as const;
...
const stage = {
  ...
  object_refs: [{ object_type: 'execution_package', object_id: 'pkg-1', href: '/executions/exec-1' }],
  blockers: [],
  evidence_refs: [],
