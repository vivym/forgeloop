...
describe('ProductAction contracts', () => {
  ...
  it('only allows same-origin relative UI hrefs on approved route prefixes', () => {
    for (const href of [
      ...
      '/development-plans/development-plan-1/items/development-plan-item-1/implementation-plan/generate-draft',
      '/development-plans/development-plan-1/items/development-plan-item-1/implementation-plan/extra',
