...
export const defaultProductApiResponses: ProductApiResponseMap = {
  ...
  'GET /query/requirements/req-1/evidence': { object_ref: requirementDetail.ref, evidence_refs: sourceObjectEvidenceRefs.requirement },
  ...
  'GET /query/initiatives/init-1/evidence': { object_ref: initiativeDetail.ref, evidence_refs: sourceObjectEvidenceRefs.initiative },
  ...
  'GET /query/tech-debt/td-1/evidence': { object_ref: techDebtDetail.ref, evidence_refs: sourceObjectEvidenceRefs.techDebt },
  ...
  'GET /query/bugs/bug-1/evidence': { object_ref: bugDetail.ref, evidence_refs: sourceObjectEvidenceRefs.bug },
