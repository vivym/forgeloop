...
export const developmentPlanItem = {
  ...
  summary: 'Replace legacy Task route clients with Development Plan Item scoped product clients.',
  driver_actor_id: actorId,
  ...
  answers: [
    {
      ...
      text: 'Remove public Task, direct Spec, and direct Plan routes from the product shell.',
      actor_id: actorId,
...
export const boundarySummary = {
  ...
  summary: 'Replace public legacy Task and direct Spec/Plan product surfaces with item-scoped AI-native clients.',
...
export const codeReviewHandoff = {
  ...
  reviewer_actor_id: 'actor-reviewer',
  status: 'in_review',
  summary: 'Review Web client and fixture migration away from public Task routes.',
    ...
    actions: [
      {
        ...
        target: {
          ...
          href: `/code-review-handoffs/${codeReviewHandoff.id}`,
        },
      },
    ],
  },
