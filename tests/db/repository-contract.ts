...
const executionFixture = (overrides: Partial<Execution> = {}): Execution => ({
  ...
  current_step: 'Repository contract supervision checkpoint',
  stale: false,
  blocked: false,
  last_event_at: '2026-05-24T00:08:00.000Z',
  last_event_summary: 'Repository contract checkpoint recorded by actor-reviewer.',
  evidence_refs: [],
